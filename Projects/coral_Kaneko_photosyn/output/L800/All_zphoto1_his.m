...
% 基本設定
file = {
    'coral_bl_T13_L800-zphot1_his.csv', ...
    'coral_bl_T17_L800-zphot1_his.csv', ...
    'coral_bl_T21_L800-zphot1_his.csv', ...
    'coral_bl_T25_L800-zphot1_his.csv', ...
    'coral_bl_T29_L800-zphot1_his.csv', ...
    'coral_bl_T33_L800-zphot1_his.csv'};
...
for i = 1:length(plot_hd)
    ...
    for j = 1:length(file)
        ...
        data_mat = readmatrix(now_file, 'NumHeaderLines', 1, 'Delimiter', ',');
